...
namespace FrontendGamePlayTags
{
	...
	TEAM15CH3PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Frontend_Widget_OptionsScreen);

	TEAM15CH3PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Frontend_Widget_ConfirmScreen);
	TEAM15CH3PROJECT_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Frontend_Widget_BattleScreen);
}