...
ANuclearAttacks::ANuclearAttacks()
{
...
void ANuclearAttacks::BeginPlay()
{
	Super::BeginPlay();
...
void ANuclearAttacks::Tick(float DeltaTime)
{
...
void ANuclearAttacks::StopMoving()
{
	bIsMoving = false;
}

void ANuclearAttacks::StartMoving()
{
	bIsMoving = true;
}


void ANuclearAttacks::Explode()
{
	if (bExploded) return;
	bExploded = true;
